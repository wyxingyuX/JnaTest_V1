...
public class NlpirTest {
	...
	public interface CLibrary extends Library {
		...
		CLibrary Instance = (CLibrary) Native.loadLibrary(
				"F:\\Code\\EclipseWorkSpace\\workspace\\nlpir20140928\\lib\\win64\\NLPIR", CLibrary.class);
	...
	public static void standardMain(String[] args) throws Exception {
		String argu = "F:\\Code\\EclipseWorkSpace\\workspace\\nlpir20140928";
	...
	public static void main(String[] args){
		...
		String source="F:\\ExpData\\DataIntegate\\source\\nne\\Weibos\\oneWeiboOneLine.txt";
		String dest="F:\\ExpData\\DataIntegate\\source\\nne\\Weibos\\oneWeiboOneLineFc.txt";
		//String nativeBytes = null;
		try {
			WeiboParser weiboParser=new WeiboParser();
			weiboParser.parse(source, dest, CLibrary.Instance);		
